...
| [HLS cameras and servers](../3-publish/09-hls-cameras-and-servers.md)   | Low-Latency HLS, MP4-based HLS, MPEGTS-based HLS | **Video**: AV1, VP9, H265, H264<br/>**Audio**: Opus, MPEG-4 Audio (AAC)<br/>**Other**: KLV (MPEGTS-based HLS only)                                                                                                                                     |
