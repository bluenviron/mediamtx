...
| Opus decoder                              | 🟢 (Phase 1 + Phase 2a/2b/2c.1/2c.2a — framing, range coder, CELT foundation + coarse energy + tf/spread + init_caps/dyn_alloc/alloc_trim shipped; see [`src/Mediar.Codecs.Opus.Decoder/README.md`](src/Mediar.Codecs.Opus.Decoder/README.md). Phases 2c.2b–6 deliver CELT compute_allocation / PVQ / IMDCT, SILK, hybrid, resampler, multistream.) |
