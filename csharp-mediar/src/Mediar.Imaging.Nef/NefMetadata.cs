...
/// <summary>
/// Nikon-specific metadata parsed from the NEF file (mostly EXIF / IFD0 tags).
/// </summary>
public sealed record NefMetadata
{
    /// <summary>EXIF Make (always "NIKON CORPORATION" for genuine NEF files).</summary>
    public required string? Make { get; init; }

    /// <summary>EXIF Model (e.g. "NIKON D850").</summary>
    ...
    /// <summary>Number of bytes occupied by the raw Nikon MakerNote (tag 0x927C), or 0 if absent.</summary>
    public required int MakerNoteLength { get; init; }
}

/// <summary>Public view of a single NEF sub-image (typically IFD 0 + one SubIFD per pyramid level).</summary>
public sealed record NefSubImageInfo
{
    ...
    /// <summary>TIFF compression tag (1 = uncompressed, 7 = JPEG, 34713 = Nikon NEF compressed).</summary>
