...
/// <summary>
/// Nikon-specific metadata parsed from the NRW file (mostly EXIF / IFD 0 tags).
/// </summary>
public sealed record NrwMetadata
{
    /// <summary>EXIF Make ("NIKON" or "Nikon" for genuine NRW files).</summary>
...
/// <summary>Public view of a single NRW sub-image (typically IFD 0 plus one SubIFD per pyramid level).</summary>
public sealed record NrwSubImageInfo
{
    ...
    /// 34713 = Nikon-compressed RAW (proprietary, not yet supported).
    /// </summary>
