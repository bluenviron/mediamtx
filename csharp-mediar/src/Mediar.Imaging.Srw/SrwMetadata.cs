...
/// <summary>
/// Samsung-specific metadata parsed from the SRW file (mostly EXIF / IFD 0 tags).
/// </summary>
public sealed record SrwMetadata
{
    /// <summary>EXIF Make ("SAMSUNG TECHWIN" / "SAMSUNG ELECTRONICS CO.,LTD." / "SAMSUNG" / "Samsung" for genuine SRW files).</summary>
    public required string? Make { get; init; }

    /// <summary>EXIF Model (e.g. "NX1", "NX300", "GT-N7100").</summary>
    ...
    /// <summary>Number of bytes occupied by the raw Samsung MakerNote (tag 0x927C), or 0 if absent.</summary>
    public required int MakerNoteLength { get; init; }
}

/// <summary>Public view of a single SRW sub-image (typically IFD 0 plus one SubIFD per pyramid level).</summary>
public sealed record SrwSubImageInfo
{
    ...
    /// 32770 = Samsung-compressed RAW (proprietary, not yet supported).
    /// </summary>
