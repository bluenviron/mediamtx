...
/// <summary>
/// Sony-specific metadata parsed from the ARW file (mostly EXIF / IFD 0 tags).
/// </summary>
public sealed record ArwMetadata
{
    /// <summary>EXIF Make (always "SONY" for genuine ARW files).</summary>
    public required string? Make { get; init; }

    /// <summary>EXIF Model (e.g. "ILCE-7M4").</summary>
...
/// <summary>Public view of a single ARW sub-image (typically IFD 0 plus one SubIFD per pyramid level).</summary>
public sealed record ArwSubImageInfo
{
    ...
    /// <summary>
    /// TIFF compression tag. 1 = uncompressed, 7 = JPEG (standard JPEG-in-TIFF), 32767 = Sony ARW v1
    /// 8-bit packed (proprietary), 32769 / 32770 = Sony ARW v2 lossless / lossy (proprietary).
    /// </summary>
