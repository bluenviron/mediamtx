...
/// <summary>
/// Test-only NEF (TIFF-based Nikon RAW) byte-stream synthesiser. Emits a
/// little-endian TIFF 6.0 container with an EXIF Make tag set to a Nikon
/// brand string (the marker by which <see cref="Mediar.Imaging.Nef.NefReader"/>
/// identifies a NEF file). SubIFDs are emitted via tag 0x014A.
/// </summary>
internal static class TestNefBuilder
{
