...
/// <summary>
/// Test-only PEF (TIFF-based Pentax RAW) byte-stream synthesiser. Emits a
/// little-endian TIFF 6.0 container with an EXIF Make tag set to a Pentax
/// or Ricoh brand string (the marker by which
/// <see cref="Mediar.Imaging.Pef.PefReader"/> identifies a PEF file).
/// SubIFDs are emitted via tag 0x014A.
/// </summary>
internal static class TestPefBuilder
{
