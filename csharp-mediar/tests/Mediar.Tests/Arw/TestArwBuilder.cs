...
/// <summary>
/// Test-only ARW (TIFF-based Sony RAW) byte-stream synthesiser. Emits a
/// little-endian TIFF 6.0 container with an EXIF Make tag set to a Sony
/// brand string (the marker by which <see cref="Mediar.Imaging.Arw.ArwReader"/>
/// identifies an ARW file). SubIFDs are emitted via tag 0x014A.
/// </summary>
internal static class TestArwBuilder
{
