...
/// <summary>
/// Test-only 3FR (TIFF-based Hasselblad RAW) byte-stream synthesiser.
/// Emits a little-endian TIFF 6.0 container with an EXIF Make tag set
/// to a Hasselblad brand string (the marker by which
/// <see cref="Mediar.Imaging.ThreeFr.ThreeFrReader"/> identifies a 3FR
/// file). SubIFDs are emitted via tag 0x014A.
/// </summary>
internal static class TestThreeFrBuilder
{
