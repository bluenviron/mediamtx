...
/// <summary>
/// Test-only SRW (TIFF-based Samsung NX RAW) byte-stream synthesiser.
/// Emits a little-endian TIFF 6.0 container with an EXIF Make tag set to
/// a Samsung brand string (the marker by which
/// <see cref="Mediar.Imaging.Srw.SrwReader"/> identifies an SRW file).
/// SubIFDs are emitted via tag 0x014A.
/// </summary>
internal static class TestSrwBuilder
{
