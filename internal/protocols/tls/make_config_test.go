...
import (
	...
	tlsmediamtx "github.com/bluenviron/mediamtx/internal/protocols/tls"
)
...
func TestMakeConfigFingerprint(t *testing.T) {
	...
	conf := tlsmediamtx.MakeConfig("33949e05fffb5ff3e8aa16f8213a6251b4d9363804ba53233c4da9a46d6f2739")
